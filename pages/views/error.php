...
<html>
    ...
    <body onload="Start()">
        ...
        <div class="main2 d-flex justify-content-center container p-9 ">
    ...
    <script charset="utf-8">
        ...
        function Start () {
          ...
          scoreText = new Text("Score: " + score, 5, 50, "left", "#212121", "30");
          highscoreText = new Text("Highscore: " + highscore, canvas.width - 5, 50, "right", "#212121", "30");
