                            ...
                            <form action="" method="POST" accept-charset="utf-8">
                                ...
                                <div class="row g-1 pt-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="" name="from_right" id="from_right">
                                            <label class="form-check-label" for="from_right">Venait de droite</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="" name="skip_priority" id="skip_priority">
                                            <label class="form-check-label" for="from_right">N'a pas respecté la priorité ou un feu rouge</label>
                                        </div>
                                    </div>
                                </div>
                            </form>
