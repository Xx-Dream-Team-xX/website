    ...
    <body onload="onLoad()">
        ...
        <div class="container-xl main" id="main">
            <div class="row m-3 mt-0 center-block order border-2 rounded p-3 shadow">
                ...
                <?php if (getPermissions() === User::GESTIONNAIRE) echo '<button class="btn btn-primary m-2 mt-3 p-2" onclick="javascript:window.location.href = `/addcontrat`;">Créer un nouveau contrat</button>';?>
