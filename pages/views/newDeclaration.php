                    ...
                    <div class="row pb-3 g-3">
                        ...
                        <div class="row g-3">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" value="1" name="ima_cert" id="ima_cert">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <select class="form-select" aria-label="user" name="old_physical" id="old_physical" required>
                        ...
                        <div class="row mt-0 g-3">
                            <div class="col-sm-9">
                                <div class="form-check">
                                    ...
                                    <input class="form-check-input" type="checkbox" value="1" name="old_agree_destruction" id="old_agree_destruction">
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <select class="form-select" aria-label="user" name="new_physical" id="new_physical" required>
                                    <option value="1" selected>Personne physique</option>
                                    <option value="0">Personne morale</option>
                                </select>
                            </div>
